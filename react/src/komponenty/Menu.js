       ...
       <div className = 'menu-kontener'>
        <Link to='/' className = 'menu-logo' onClick={zamknijNawigator}>
            ...
            <li className = 'podmiot-nawigatora1'>
              ...
              {przycisk && <Przycisk className = 'btn--outline' stylPrzycisku={'btn--outline'} linkPrzycisku={'/Rejestracja'}>Zarejestruj sie</Przycisk>}
              {przycisk && <Przycisk className = 'btn--outline' stylPrzycisku={'btn--outline'} linkPrzycisku={'/Logowanie'}>Zaloguj sie</Przycisk>}
        </div>
    </nav>
    </>
  )
